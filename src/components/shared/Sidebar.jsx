...
const Sidebar = () => {
  ...
  return (
    <div className=" sidebar:w-[250px] h-screen  p-2 sidebar:p-4 pb-6 z-10 bg-white">
      <div className="h-full flex flex-col justify-between">
        <div className="flex flex-col items-center gap-8 pt-6 sidebar:pt-0">
          <div className="sidebar:p-10 ">
            <img src="/logo.png" alt="logo" className="w-full sidebar:block hidden" />
          ...
          <div className="w-full flex flex-col gap-2">
            {listArray.map( (item, i) => {
              ...
              return (
                ...
                <div key={i} className=" p-3 rounded-sidebar flex gap-4 items-center hover:cursor-pointer hover:bg-neutral-200/50 transition-all">
                  <item.icon />
          ...
          <CreateModal />
            <div className=" p-3 rounded-sidebar flex gap-4 items-center hover:cursor-pointer hover:bg-neutral-200/50 transition-all">
